          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            ...
            >
              ...
              <div className="p-6 space-y-5">
                <div>
                  <label className="text-[10px] font-bold uppercase text-slate-400 tracking-wider mb-1.5 block">Nome da Pasta</label>
                  <input
                    type="text"
                    value={name}
                ...
                <div>
                  <label className="text-[10px] font-bold uppercase text-slate-400 tracking-wider mb-2 block">Ícone</label>
                ...
                <div>
                  <label className="text-[10px] font-bold uppercase text-slate-400 tracking-wider mb-2 block">Cor</label>
                  <div className="flex flex-wrap gap-2">
